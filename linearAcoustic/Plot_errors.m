function [] = Plot_errors( ERRS,mesh_size,step_size,string1,s,figurenumber)
...
%% Plotting the reference line
 ...
 loglog((step_size),4*step_size.^s,'--k')
 %% Title
...
%     '$h = 2^{-5/2}$','$h = 2^{-3}$','$h = 2^{-7/2}$','$\mathcal O(\tau^2)$' },'location','southeast','FontSize',9);
  ...
  legend({'$h = 2^{0}$','$h = 2^{-1}$','$h = 2^{-2}$',...
    '$h = 2^{-3}$','$h = 2^{-4}$',...
     '$\mathcal O(\tau^2)$' },'location','southeast','FontSize',9);
...
%legend({strcat('dof = ',num2str(dof_s(4))),strcat('dof = ',num2str(dof_s(5))),...
 ...
 l=legend({strcat('$N$ = ',num2str(N_s(1))),strcat('$N$ = ',num2str(N_s(2))),strcat('$N$ = ',num2str(N_s(3))),strcat('$N$ = ',num2str(N_s(4))),...
    strcat('$N$ = ',num2str(N_s(5))),strcat('$N$ = ',num2str(N_s(6))),strcat('$N$ = ',num2str(N_s(7))),strcat('$N$ = ',num2str(N_s(8))),'$\mathcal O(h^{3/2})$'},'Interpreter','Latex','location','southeast','Fontsize',9);
