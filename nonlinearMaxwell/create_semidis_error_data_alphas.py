...
filename = 'data/density_sphere_h_'+str(np.round(h_ref,3)) +'_N_'+str(N_ref)+'_m_'+str(m_ref)+ '_a_'+str(alpha)+'.npy'
...
for space_index in range(Am_space):
    ...
    #   resc_ref=sol_ref
        ...
        res["hs"]= hs
        res["taus"]= taus
        scipy.io.savemat("data/error_m_2_space_a_"+str(alpha)+".mat",res)
